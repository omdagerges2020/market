...
import { getSkincareProducts } from "../../ReduxSystem/Slices/skincareSlice";
import Loading from "./../../Loading";
import PageNotFound from "../../PageNotFound";
import { Link } from "react-router-dom";

const SeeOurSkincare = () => {
  const { skincare, loadingSkincare, errorSkincare } = useSelector(
    (state) => state.skincareProducts
  );
          ...
          >
            ...
            <div className="card-body flex flex-col items-center p-7">
              ...
              <div>
                ...
                <span className="text-[#2ec745] text-sm dark:text-gray-700">
                  (% Off)
                </span>
              </div>
